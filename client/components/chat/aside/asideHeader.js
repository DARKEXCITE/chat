...
const AsideHeader = () => {
  return (
    <div>
      <h1 className="text-white text-xl font-bold mb-2 mt-3 px-4 font-sans flex justify-between">
        <span>Tailwind CSS</span>
        <svg className="h-6 w-6 text-purple-lightest fill-current cursor-pointer" viewBox="0 0 32 32">
          <g id="surface1">
